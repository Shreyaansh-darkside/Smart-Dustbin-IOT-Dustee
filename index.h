...
<head>
  <title>Waste Management at Main Server Room</title>
...
<body>
    <div style="text-align:center;"><b>Dustbins Report @ Main- Server Room</b><br>Real Time Data Dustbins Filled  Logging with Graphs on ESP8266</div>
    <div class="chart-container" position: relative; height:350px; width:100%">
        <canvas id="Chart" width="400" height="400"></canvas>
    </div>
<div>
  <table id="dataTable">
    <tr><th>Time</th><th>ADC Value</th><th>Capacity Left(%)</th></tr>
  </table>
</div>
<br>
<br>  
...
function getData() {
  ...
  //Update Data Table
    ...
    cell3.innerHTML = obj.distanceCm;
